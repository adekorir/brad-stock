...
public class DerbyProductManager implements ProductManager {

    private DerbyCRUDOperations crudOperations;

    public DerbyProductManager(DerbyCRUDOperations derbyCRUDOperations) {
        super();

        crudOperations = derbyCRUDOperations;
    }
