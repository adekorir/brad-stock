...
public class DerbySupplierManager implements SupplierManager {

    private final DerbyCRUDOperations crudOperations;

    public DerbySupplierManager(DerbyCRUDOperations crudOperations) {
        super();
